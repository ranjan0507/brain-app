...
export default function CreateContentModal({
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    if (!title.trim() && !url.trim() && type !== "note") {
        ...
        <form onSubmit={submit} className="space-y-3">
          ...
          <div>
            ...
            <div className="flex gap-2 items-center">
              <select
                ...
                className="flex-1 p-2 bg-[#0b0b0b] rounded border border-neutral-800"
              >
                <option value="">
              ...
              <input
                ...
                className="p-2 bg-[#0b0b0b] rounded border border-neutral-800"
              />
            </div>
            <p className="text-xs text-gray-500 mt-1">
              If you provide a new category name it will be created
              automatically.
            </p>
          </div>
          ...
          <div className="flex justify-end gap-2">
            <button
              type="button"
              onClick={onClose}
              className="text-gray-400 px-3 py-1 rounded"
            >
              Cancel
            </button>
            <button
